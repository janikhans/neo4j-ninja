...
class PartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post parts_url, params: { part: { part_number: @part.part_number, product_id: @part.product_id } }
    end
  ...
  test "should update part" do
    patch part_url(@part), params: { part: { part_number: @part.part_number, product_id: @part.product_id } }
